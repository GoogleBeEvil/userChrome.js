...
// @startup        MyMoveButton.init();
// @shutdown       MyMoveButton.unint();
// @note           2018/02/03 修复58+
...
location == "chrome://browser/content/browser.xul" && (function(){
	...
	// {id:"support_lastpass_com-browser-action",insertBefore: "star-button-box"},
        ...
        // { id: "PanelUI-menu-button", bar: "PersonalToolbar" },
           { id: "bookmarksMenu", insertAfter: "context-sep-navigation", clone: true },
    ...
    window.MyMoveButton = {
        ...
        moveOneButton: function(info) {
            ...
            // 先设置属性
            if (info.attr) {
                for (let key of info.attr ) {
                	  let val = info.attr[key];
