...
(function () {
    ...
    let config = {
        ...
        extraAppName:"迅雷下载",//下载工具名称
        extraAppPath:"D:\\Soft\\ThunderVIP\\Program\\Thunder.exe", //路径
    ...
    var MDownloadPlus = {
        createExtraAppButton:function () {
            var btn = document.getAnonymousElementByAttribute(document.querySelector("*"), "dlgtype", "extra2");
            if(btn){
        ...
        lauchExtraApp:function () {
            ...
            try {
                ...
                ss.openApplicationWithURI(extraApp, url);
            } catch (e) {
        ...
        createSaveAsButton(){
            ...
            if(autodownload){
                var btn = document.getAnonymousElementByAttribute(document.querySelector("*"), "dlgtype", "extra1");
                if(btn){
                    btn.setAttribute("hidden", "false");
